...
For 1.x versions of FastScore, there is also a Python CLI ([Python CLI reference](/Python%20CLI)). However, the Python CLI will be deprecated, starting in FastScore version 2.x.
