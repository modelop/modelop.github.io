---
title: The FastScore Go CLI User Guide
description: The guide describes all commands available through the FastScore Go CLI with their respective options.
css: buttondown.css
---

# FastScore CLI v1.10 User Guide
